...
import com.example.buddget.dto.item.ItemResponse;
...
public record SpendingResponse(
        ...
        public SpendingResponse(Long spendingId, Long userId, String companyName, Float totalPrice, LocalDateTime date, List<ItemResponse> products, String imageName, String description) {
